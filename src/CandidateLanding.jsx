...
import { ArrowRight, ShieldAlert, Landmark, Building2, Hammer, Gavel, Lock, ArrowUpRight, Send, Info, Sprout } from "lucide-react";
...
export default function CandidateLanding() {
  ...
  useEffect(() => {
    ...
    if (gridRef.current) {
      ...
      // Visibles por defecto; animación sutil al entrar
      gsap.from(cards, {
      ...
      <nav className="sticky top-0 z-40 bg-white/90 backdrop-blur border-b border-neutral-200">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3" data-fade>
            ...
            <span className="font-semibold tracking-wide" style={{ color: COLORS.navy }}>Cristián Daly — Diputado</span>
          </div>
          <div className="hidden md:flex items-center gap-6 text-sm" ref={heroRef}>
            ...
            <a href="#contacto" className="inline-flex items-center gap-1 px-3 py-1.5 rounded-full text-white" style={{ background: COLORS.navy }} data-fade>
        ...
        <div className="max-w-7xl mx-auto px-4 pt-14 pb-16 grid md:grid-cols-12 gap-10 items-center">
          <div className="md:col-span-7">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <a href="#propuesta1" className="group inline-flex items-center gap-2 px-5 py-3 rounded-2xl font-medium text-white" style={{ background: COLORS.navy }} data-fade>
                Propuesta más urgente
                <ArrowRight className="w-5 h-5 group-hover:translate-x-0.5 transition-transform" />
              </a>
              <a href="#propuestas" className="inline-flex items-center gap-2 px-5 py-3 rounded-2xl border border-neutral-300 hover:bg-neutral-50 transition" data-fade>
          ...
          <div className="md:col-span-5 relative" data-fade>
            <div className="rounded-3xl overflow-hidden border border-neutral-200 bg-white shadow-sm">
              <div className="p-6 md:p-8">
                ...
                <h3 className="mt-4 text-2xl md:text-3xl font-bold" style={{ color: COLORS.navy }}>¡Elimina las contribuciones de tu vivienda!</h3>
                ...
                <div className="mt-6 flex items-center gap-3">
                  <div className="px-4 py-2 rounded-full text-sm font-semibold text-white" style={{ background: COLORS.amber, color: COLORS.ink }}>
                    Prioridad #1
                  </div>
...
<section id="bio" ref={bioRef} className="py-16 bg-neutral-50">
  <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-12 gap-10 items-center">
    ...
    {/* Imagen */}
    <div className="lg:col-span-7">
      <div className="relative rounded-[2rem] overflow-hidden border border-neutral-200 shadow-sm  max-h-[560px] mx-auto"
      ...
      <section id="contacto" className="py-16">
        <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-3 text-neutral-700 max-w-xl">Inscríbete para ser apoderado, voluntario o simplemente mantenerte informado del avance legislativo y actividades de campaña.</p>
          </div>
          <form className="bg-white rounded-2xl p-6 border border-neutral-200 grid grid-cols-1 gap-4 shadow-sm">
            ...
            <button type="button" className="mt-2 inline-flex items-center justify-center gap-2 px-5 py-3 rounded-2xl font-semibold text-white" style={{ background: COLORS.navy }}>Enviar interés <ArrowUpRight className="w-5 h-5"/></button>
          </form>
        </div>
      </section>
